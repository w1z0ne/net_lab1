...
class SingleSwitchTopo(Topo):
    def build(self):
        ...
        self.addLink(host1, switch1, bw=10, delay='5ms', loss=0.1, use_htb=True)
        self.addLink(switch1, host2, bw=10, delay='5ms', loss=0, use_htb=True)
        # self.addLink(switch2, switch3, bw=10, delay='5ms', loss=0, use_htb=True)
        self.addLink(switch1, host3, bw=10, delay='5ms', loss=0, use_htb=True)
